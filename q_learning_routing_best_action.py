...
class QLearningRouting_BestAction(BASE_routing):
    ...
    def relay_selection(self, opt_neighbors: list, packet):
        ...
        policy_name = "best_action_policy" # greedy_policy | best_action_policy
    ...
    def get_action(self, state, opt_neighbors, policy_name="best_action_policy"):
        ...
        force_exploration = len(self.q_table[state].keys()) == 0
    
        # do exploration if force exploration, or in the epsilon case
        if force_exploration or self.simulator.rnd_routing.rand() < self.epsilon:
            # keep the packet
